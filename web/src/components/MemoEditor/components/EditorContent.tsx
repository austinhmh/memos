...
export const EditorContent = forwardRef<EditorRefActions, EditorContentProps>(({ placeholder, compact }, ref) => {
  ...
  return (
    <div className={`w-full flex flex-col ${compact ? "" : "flex-1"}`} {...dragHandlers}>
      <Editor
        ref={ref}
