...
func TestGatewayPublicPathACL(t *testing.T) {
	publicPaths := []struct {
		...
		{http.MethodGet, "/api/v1/instance/settings/MEMO_RELATED"},
	...
	protectedPaths := []struct {
		...
		{http.MethodGet, "/api/v1/instance/settings/STORAGE"},
		{http.MethodGet, "/api/v1/instance/settings/BASIC"},
		{http.MethodGet, "/api/v1/instance/settings/general"},
		{http.MethodGet, "/api/v1/instance/settings/GENERAL/extra"},
		{http.MethodPost, "/api/v1/users/1/personalAccessTokens"},
		{http.MethodGet, "/api/v1/memos/1/attachments"},
		{http.MethodPatch, "/api/v1/memos/1/attachments"},
		{http.MethodGet, "/api/v1/attachments"},
		{http.MethodGet, "/api/v1/attachments/1"},
		{http.MethodPost, "/api/v1/attachments"},
		{http.MethodPatch, "/api/v1/attachments/1"},
		{http.MethodDelete, "/api/v1/attachments/1"},
		{http.MethodGet, "/file/backgrounds"},
		{http.MethodGet, "/file/backgrounds/bg/_bg_wallpaper.png"},
